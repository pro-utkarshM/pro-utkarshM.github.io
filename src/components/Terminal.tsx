...
export const commands: Command = [
  { cmd: "hello", desc: "say hello!", tab: 8 },
  ...
  { cmd: "skills", desc: "see my skills ", tab: 7 },
  { cmd: "gui", desc: "see my portfolio in GUI", tab: 10 },
  { cmd: "help", desc: "check available commands", tab: 9 },
 // { cmd: "Utkarsh", desc: "about Utkarsh", tab: 6 },
  { cmd: "call", desc: "contact me", tab: 9 },
  { cmd: "resume", desc: "see my resume", tab: 7 },
  { cmd: "blogs", desc: "read my blogs", tab: 8 },
  ...
  { cmd: "exit", desc: "close page", tab: 9 },
